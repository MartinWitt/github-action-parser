...
@JsonPropertyOrder({"name", "on", "jobs"})
public class GitHubWorkflow {
    ...
    public String toString() {
        ...
        sb.append(GitHubWorkflow.class.getName())
                .append('@')
    ...
    public boolean equals(Object other) {
        ...
        return (((((this.name == rhs.name) || ((this.name != null) && this.name.equals(rhs.name)))
                        ...
                        && ((this.on == rhs.on) || ((this.on != null) && this.on.equals(rhs.on))))
                && ((this.jobs == rhs.jobs) || ((this.jobs != null) && this.jobs.equals(rhs.jobs))));
    }
}

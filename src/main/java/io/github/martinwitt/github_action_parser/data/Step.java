...
public class Step {
    ...
    public boolean equals(Object other) {
        ...
        Step rhs = ((Step) other);
        return (((((((((((this.with == rhs.with) || ((this.with != null) && this.with.equals(rhs.with)))
                                                                ...
                                                                && ((this.uses == rhs.uses)
                                                                        || ((this.uses != null)
                                                                                && this.uses.equals(rhs.uses))))
                                                        && ((this.run == rhs.run)
                                                                || ((this.run != null) && this.run.equals(rhs.run))))
                                                && ((this.additionalProperties == rhs.additionalProperties)
                                                        || ((this.additionalProperties != null)
                                                                && this.additionalProperties.equals(
                                                                        rhs.additionalProperties))))
                                        && ((this.env == rhs.env) || ((this.env != null) && this.env.equals(rhs.env))))
                                && ((this._if == rhs._if) || ((this._if != null) && this._if.equals(rhs._if))))
                        && ((this.timeoutMinutes == rhs.timeoutMinutes)
                                || ((this.timeoutMinutes != null) && this.timeoutMinutes.equals(rhs.timeoutMinutes))))
                && ((this.continueOnError == rhs.continueOnError)
                        || ((this.continueOnError != null) && this.continueOnError.equals(rhs.continueOnError))));
    }
}

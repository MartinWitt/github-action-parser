...
@JsonPropertyOrder({"name", "needs", "runs-on", "steps"})
public class JobsProperty {
    ...
    public String toString() {
        ...
        sb.append(JobsProperty.class.getName())
                .append('@')
    ...
    public boolean equals(Object other) {
        ...
        return ((((((this.name == rhs.name) || ((this.name != null) && this.name.equals(rhs.name)))
                                        && ((this.needs == rhs.needs)
                                                || ((this.needs != null) && this.needs.equals(rhs.needs))))
                                && ((this.runsOn == rhs.runsOn)
                                        || ((this.runsOn != null) && this.runsOn.equals(rhs.runsOn))))
    ...
    public enum RunsOn {
        ...
        private static final Map<String, JobsProperty.RunsOn> CONSTANTS = new HashMap<String, JobsProperty.RunsOn>();
